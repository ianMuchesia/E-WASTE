    ...
    <div className="xl:mx-60">
      ...
      <div className="grid place-items-center xl:mx-70">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <button className=" w-[250px] h-[60px] text-black font-bold mt-4 rounded border-2">
            <Link to="/RepairShop">Back to Repair Shop </Link>
          </button>
        </div>
      </div>
      <div className="mt-12">
              ...
              >
                <div className="rounded shadow-sm shadow-[#B95E09] w-[90%]">
                  ...
                  <div className="px-6 py-4">
                    ...
                    <p className="text-gray-700 text-lg text-center">Located in 
                        {" "}{otherTechnician.shopLocation}
                    </p>
                  </div>
                </div>
              </div>
